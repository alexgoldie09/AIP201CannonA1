...
public class CustomCollider: MonoBehaviour
{
    ...
    [SerializeField]
    private float destroyThresholdY = -10f; // The y-position threshold below which the object is destroyed (Used to ensure objects don't remain in scene once fallen).
